...
set CLASSPATH=%APP_HOME%\lib\java-test.jar;%APP_HOME%\lib\guava-21.0.jar

@rem Execute java-test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAVA_TEST_OPTS%  -classpath "%CLASSPATH%" App %CMD_LINE_ARGS%
