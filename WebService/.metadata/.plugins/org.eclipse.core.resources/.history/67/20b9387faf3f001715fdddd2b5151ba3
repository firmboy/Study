package org.sky.axis2.helloTest;
...
public class HelloWorldWithReturnClient {
     ...
     "http://localhost:8080/webClient/services/HelloTest");
	public void sayHello() {
		Options options = new Options();
		options.setAction("urn:helloTest");
		...
		try {
		     ...
		     OMElement method = fac.createOMElement("helloTest", omNs);
